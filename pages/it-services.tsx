  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {/* Visitor List Section - Removed stats and area stats here */}
        {false && stats && (
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Companions Reg.</p>
                  <p className="text-2xl font-bold text-blue-600">{stats.companionsRegistered}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Companions Inside</p>
                  <p className="text-2xl font-bold text-purple-600">{stats.companionsArrived}</p>
                </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600">Arrival Rate</p>
                  <p className="text-2xl font-bold text-orange-600">{stats.arrivalRate}%</p>
                </div>
